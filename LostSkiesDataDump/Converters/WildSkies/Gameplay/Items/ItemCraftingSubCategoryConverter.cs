...
public class ItemCraftingSubCategoryConverter<T>
    : ScriptableObjectConverter<T>,
        IConverterDefault<ItemCraftingSubCategoryConverter<ItemCraftingSubCategory>>
    where T : ItemCraftingSubCategory
{
    public static new ItemCraftingSubCategoryConverter<ItemCraftingSubCategory> Default { get; } =
        new();
