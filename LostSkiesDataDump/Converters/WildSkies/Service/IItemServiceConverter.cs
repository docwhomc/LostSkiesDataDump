...
public class IItemServiceConverter<T>
    : BaseConverter<T>,
        IConverterDefault<IItemServiceConverter<IItemService>>
    where T : IItemService
{
    public static IItemServiceConverter<IItemService> Default { get; } = new();
