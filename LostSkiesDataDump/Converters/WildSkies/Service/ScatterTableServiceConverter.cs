...
public class ScatterTableServiceConverter<T>
    : BaseConverter<T>,
        IConverterDefault<ScatterTableServiceConverter<ScatterTableService>>
    where T : ScatterTableService
{
    public static ScatterTableServiceConverter<ScatterTableService> Default { get; } = new();

    public ScatterTableServiceConverter()
        : base(false) { }
    ...
    {
        WriteProperty(writer, value._scatterTables, options);
